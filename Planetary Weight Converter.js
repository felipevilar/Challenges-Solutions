...
To convert the weight, you have to divide it by the gravitational force of the planet on which is weighed and multiply the result (the mass) 
...
function spaceWeights(planetA, weight, planetB) {
    return Number(((weight/gravitational[planetA])*gravitational[planetB]).toFixed(2))
}
